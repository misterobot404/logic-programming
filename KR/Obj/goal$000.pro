...
%BEGIN Task Window, e_Create
  ...
  dlg_game_Create(_Win), win_Destroy(_Win),
...
%BEGIN game, ControlList, 19:35:22-29.4.2019, Code automatically updated!
		...
		df(idc_value2,editstr("4",[]),nopr),
		df(idc_value3,editstr("6",[]),nopr),
		df(idc_value4,editstr("11",[]),nopr),
		df(idc_value5,editstr("5",[]),nopr),
		df(idc_value6,editstr("10",[]),nopr),
		df(idc_value7,editstr("9",[]),nopr),
		df(idc_value8,editstr("1",[]),nopr),
		df(idc_value9,editstr("2",[]),nopr),
		df(idc_value10,editstr("15",[]),nopr),
		df(idc_value11,editstr("3",[]),nopr),
		df(idc_value12,editstr("14",[]),nopr),
		df(idc_value13,editstr("12",[]),nopr),
		df(idc_value14,editstr("7",[]),nopr),
		df(idc_value15,editstr("13",[]),nopr),
		df(idc_value16,editstr("8",[]),nopr),	
		
		df(idc_debug,listbox(["Èíñòğóêöèÿ:","1.Çàïîëíèòå èãğîâîå ïîëå ÷èñëàìè îò 1 äî 15",
		"2.Îòñîğòèğóéòå èõ â ïîğÿäêå âîçğàñòàíèÿ","3.Åñëè çàïóòàëèñü íàæìèòå Âåğíûé õîä"],[0]),nopr)
...
%BEGIN rules, CreateParms, 20:20:40-26.4.2019, Code automatically updated!
...
%MARK rules, new variables
	...
	dialog_CreateModal(Parent,dlg_rules_ResID,"",
  		[
%BEGIN rules, ControlList, 20:20:40-26.4.2019, Code automatically updated!
...
%BEGIN rules, Update controls, 20:20:40-26.4.2019, Code automatically updated!
